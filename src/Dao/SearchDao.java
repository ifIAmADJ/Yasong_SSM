...
public interface SearchDao {
    ...
    List<Map<String,Object>> SearchUserPoemsByKeyWord(@Param("keyWord") String keyWord);
    List<Map<String,Object>> SearchPoetsByKeyWord(@Param("keyWord") String keyWord);
    List<Map<String,Object>> SearchClassicalPoemsByKeyWord(@Param("keyWord") String keyWord);
